...
We can resume the differences between s1 and s2 in the following string: "1:aaaa/2:bbb" 5.whereMyAnagramsAt 1 in 1:aaaa stands for string s1 and aaaa because the maximum for a is 4. In the same manner 2:bbb stands for string s2 and bbb because the maximum for b is 3.

The task is to produce a string in which each lowercase letters of s1 or s2 appears as many times as its maximum if this maximum is strictly greater than 1; these letters will be prefixed by the number of the string 5.whereMyAnagramsAt they appear with their maximum value and :. If the maximum is in s1 as well as in s2 the prefix is =:.
